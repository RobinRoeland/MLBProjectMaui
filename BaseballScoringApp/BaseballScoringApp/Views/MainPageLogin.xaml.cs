    ...
    public partial class MainPageLogin : ContentPage
    {
        ...
        private async void OnLoginButtonClicked(object sender, EventArgs e)
        {
            ...
            if (AuthenticateUser(email, password).Result)
            {
                ...
                // chech status of database and initialse with teams and players if empty
                BBDataRepository repo = BBDataRepository.getInstance();
                WaitingOverlay.IsVisible = true;
                await repo.verifyInitialisationNeededWithTeamData(this);
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    if (isAuthenticatedElement.GetBoolean())
                    {
                        ...
                        Globals.loggedInUser = loginModel.Email;
                        return true;
                    }
                    else
                    {
